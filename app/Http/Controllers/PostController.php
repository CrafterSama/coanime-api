...
class PostController extends Controller
{
    ...
    public function postsDashboard(Request $request)
    {
        ...
        // Posts autogenerados pendientes de revisión por scrapper
        $autoGeneratedPending = Post::where('auto_generated', true)
        ...
        if ($includeFilters == '1' || $includeFilters == 1 || $includeFilters === true || $includeFilters === 'true') {
            ...
            return response()->json([
                ...
                'auto_generated_pending_review' => $autoGeneratedPending,
            ], 200);
        }
