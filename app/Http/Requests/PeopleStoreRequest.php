...
class PeopleStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'bio.required_without' => 'La biografía (bio o about) es obligatoria.',
            'about.required_without' => 'La biografía (bio o about) es obligatoria.',
            ...
            'country_code.size' => 'El código de país debe tener 3 caracteres (ISO3).',
